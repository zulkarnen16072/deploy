...
AdminComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AdminComponent, selectors: [["app-admin"]], decls: 31, vars: 12, consts: [["color", "primary", 1, "example-header"], ["mat-icon-button", "", 1, "example-icon", "uk-margin-medium-right", 3, "click"], ["id", "logo", "src", "https://firebasestorage.googleapis.com/v0/b/personal-project-tekweb.appspot.com/o/logo%2Flogo_wht.png?alt=media&token=f372cf9b-a07f-405a-b6d5-4373037994fb", "alt", ""], [1, "uk-width-expand"], [1, "uk-margin-medium-left", 3, "click"], ["mat-icon-button", "", 1, "example-icon", "favorite-icon", "uk-margin-medium-left"], ["mat-icon-button", "", 1, "example-icon"], [1, "example-container"], ["opened", "", 1, "sidenav-left", 3, "mode", "position", "fixedInViewport", "fixedTopGap", "fixedBottomGap"], ["sidenav", ""], [1, "uk-margin-top"], ["routerLink", "/admin/dashboard"], ["matListIcon", ""], ["matLine", ""], ["routerLink", "/admin/product"], [1, "example-sidenav", 3, "mode", "position", "fixedInViewport", "fixedTopGap", "fixedBottomGap"], [2, "padding", "20px", "background-color", "#fff"]], template: function AdminComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", ctx.isUser ? "Log out" : "Sign In", " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
DashboardComponent.ɵfac = function DashboardComponent_Factory(t) { return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"])); };
DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DashboardComponent, selectors: [["app-dashboard"]], decls: 10, vars: 2, template: function DashboardComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "Jumlah Product:");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
